...
public class Solution {
    ...
    public static class AmigoThreadFactory implements ThreadFactory{
        ...
        public Thread newThread(Runnable r)
        {
            ...
            String format="%s-pool-%s-thread-%s";
            String threadName=String.format(format,thread.getThreadGroup().getName(), in, integer2.incrementAndGet() );
