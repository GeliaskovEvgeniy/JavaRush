...
public class View  extends JFrame implements ActionListener {
    ...
    private JEditorPane plainTextPane = new JEditorPane(); // будет отображать код html
    ...
    public void initEditor() {
        ...
        JScrollPane textScrolPane = new JScrollPane(plainTextPane);
        tabbedPane.addTab("Текст", textScrolPane);
